...
mc cp --insecure S3/eictest/EPIC/RECO/22.11.2/epic_brycecanyon/DIS/NC/${1}x${2}/minQ2=1/pythia8NCDIS_${1}x${2}_minQ2=1_beamEffects_xAngle=-0.025_hiDiv_vtxfix_1.0002.eicrecon.tree.edm4eic.root ./input/input-eicrecon-DIS_${1}x${2}_Q2-1_0002.root
